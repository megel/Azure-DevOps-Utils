...
. (Join-Path $PSScriptRoot "DistributedTasks/Get-AzureDevOpsVariableGroups.ps1")
. (Join-Path $PSScriptRoot "DistributedTasks/Add-AzureDevOpsVariableGroup.ps1")
. (Join-Path $PSScriptRoot "DistributedTasks/Update-AzureDevOpsVariableGroup.ps1")
